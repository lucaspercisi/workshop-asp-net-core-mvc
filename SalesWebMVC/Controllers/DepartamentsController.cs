...
namespace SalesWebMVC.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age")] Departament departament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age")] Departament departament)
        {
